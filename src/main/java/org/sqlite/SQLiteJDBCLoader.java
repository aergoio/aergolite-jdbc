...
public class SQLiteJDBCLoader {
    ...
    public static String getVersion() {
        ...
        URL versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.xerial/aergolite-jdbc/pom.properties");
        if(versionFile == null) {
            versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.xerial/aergolite-jdbc/VERSION");
        }
